...
node -e "package = require('./package.json');package.publishConfig.registry='$registry';package.repository='';package.version='$newversion';require('fs').writeFile('package_new.json', JSON.stringify(package, null, 4), 'utf8')"
