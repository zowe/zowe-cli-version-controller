...
//    }
    ...
    protected void _verifyReleaseLabel(String value, String user, String password, String url, String ownerRepository) {
        ...
        def process2 = steps.sh script: "curl -u\"${userpass}\" -X POST -H \"Accept: application/vnd.github.symmetra-preview+json\" $url2 --data '{\"name\":\"release-major\",\"color\":\"2b0a91\",\"description\":\"Indicates a major breaking change will be introduced\"}'", returnStdout: true
